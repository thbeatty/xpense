...
public class PreviousCategoryActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    private static String url = "http://cgi.soic.indiana.edu/~team33/previousmonthlydisplay.php";
    private static String url1 = "http://cgi.soic.indiana.edu/~team33/homepagesearch.php";
    private static String monthlyPHP = "http://cgi.soic.indiana.edu/~team33/previousMonthlyCurrentValue.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_previous_category);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case (R.id.homeNav):
                        Intent intent = new Intent(PreviousCategoryActivity.this, HomeActivity.class);
                        startActivity(intent);
                        break;

                    case (R.id.homeBudget):
                        Intent intent1 = new Intent(PreviousCategoryActivity.this, BudgetActivity.class);
                        startActivity(intent1);
                        break;

                    case (R.id.homeAdd):
                        Intent intent2 = new Intent(PreviousCategoryActivity.this, AddActivity.class);
                        startActivity(intent2);
                        break;

                    case (R.id.homeSettings):
                        Intent intent3 = new Intent(PreviousCategoryActivity.this, SettingsActivity.class);
...
//                            JSONArray jsonArray = jsonObject.getJSONArray("myArray");
                            ...
                            e.printStackTrace();
                            Toast.makeText(PreviousCategoryActivity.this, "No receipts found for this month", Toast.LENGTH_LONG).show();
                        }
                        receiptAdapter = new ReceiptAdapter(PreviousCategoryActivity.this, receiptArrayList);
...
//                            editor.commit();
                            spentValue.setText("$" + String.valueOf(currentMonthlyTotal));
